package com.apiproject.openapi.configs;
...
public class config implements WebMvcConfigurer {
    @Bean
    public InMemoryDataBase getInMemoryDataBase (){return InMemoryDataBase.getInstance();}
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.apiproject.openapi"))
